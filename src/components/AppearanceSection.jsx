  ...
  return (
    <section className="w-full flex flex-col md:flex-row items-center bg-[#F5F2EB] ">
      ...
      <div className="w-full px-16 md:w-1/2 text-center md:text-left p-6">
        <h2 className="text-3xl font-semibold text-gray-900">Enhanced Appearance</h2>
      ...
      <div className="w-full md:w-1/2 relative">
        <img
          src="/Rectangle 12.png" // Replace with your actual image URL
          alt="Enhanced Appearance"
